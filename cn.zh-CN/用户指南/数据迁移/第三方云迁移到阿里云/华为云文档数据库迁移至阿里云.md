...
4.  在基本信息页签的节点信息模块，单击**绑定弹性IP**。
    ...
    **说明：** 您可以为**Secondary**或**Primary**角色的节点绑定公网IP地址。
    ...
    ![绑定弹性IP](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/86903/154822654135967_zh-CN.png)
...
6.  在安全组设置页面中，设置允许访问华为云文档数据库端口，默认端口为 8635。
    ...
    **说明：** 如您修改过华为云文档数据库端口号，请填入您修改后的数据库端口号。
    ...
    ![设置安全组规则](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/86903/154822654135968_zh-CN.png)
...
4.  配置迁移任务的**源库及目标库**信息。
    ...
    ![源库及目标库配置](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/86903/154822654136007_zh-CN.png)
...
6.  选择**迁移对象**和**迁移类型**。
    ...
    ![设置迁移对象和迁移类型](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/86903/154822654135987_zh-CN.png)
...
**说明：** 使用全量数据迁移时，在迁移开始前需要停止华为云文档数据库的相关业务。同时为了保障数据一致性，迁移期间请勿在华为云文档数据库中写入新的数据。
 ...
 |
    |迁移对象|     -   在**迁移对象**框中将想要迁移的数据库选中，单击![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/75938/154822654133712_zh-CN.png)移动到**已选择对象**框
...
7.  上述配置完成后，单击页面右下角的**预检查并启动**。
    ...
    **说明：** 
    ...
    -   如果预检查失败，单击具体检查项后的![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/86903/154822654135996_zh-CN.png)，查看具体的失败详情。根据失败原因修复后，重新进行预检查。
8.  预检查通过后，单击**下一步**。
...
10. 单击购买并启动，迁移任务正式开始。
    ...
    -   增量数据迁移
        ...
        ![停止增量迁移任务](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/75938/154822654133674_zh-CN.png)
